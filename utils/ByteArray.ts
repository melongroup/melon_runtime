import { EgretByte, EndianConst } from "./EgretByte";
import { Int64 } from "../../melon_runtime/Int64";
 ...
 *
 */
export class ByteArray extends EgretByte {

    public $endian: EndianConst;
    ...
    public readInt64() {
        if (this.validate(ByteArraySize.SIZE_OF_INT64)) {
            ...
            let flag = this.$endian == EndianConst.LITTLE_ENDIAN;
            let data = this.data;
     ...
     * @returns {EgretByte}
     */
    public readByteArray(length: number, ext = 0): EgretByte {
    ...
    // public get outArrayBuffer() {
    //     return this._bytes.buffer.slice(0, this.write_position);
    // }
